...
const translations = {
  en: {
    ...
    continueWhereYouLeftOff: "Continue wherever you left off",
    yourProgress: "Your Progress", 
    coursesInProgress: "Courses in Progress",
    completedCourses: "Completed Courses",
    pendingAssignments: "Pending Assignments", 
    startEarningAchievements: "Start Earning Achievements",
    continueText: "Continue",
    greatJob: "Great Job",
    timeToSubmit: "Time to Submit",
    yourAchievements: "Your Achievements",
    levelUpYourLearning: "Level Up Your Learning",
    yourLevel: "Your Level",
    activeChallenges: "Active Challenges",
    recentAchievements: "Recent Achievements", 
    noActiveChallenges: "No Active Challenges",
    progressToLevel: "Progress to Level 2", 
    completeCourseAndChallenges: "Complete courses and challenges to earn your first achievement!",
    viewChallenges: "View Challenges",
    leaderboards: "Leaderboards", 
    quickChallenge: "Quick Challenge",
    searchCoursesResources: "Search courses and resources",
    dailyChallenge: "Daily Challenge",
    animationsDemo: "Animations Demo",
    share: "Share",
    viewAll: "View All",
